        ...
        if (Validator.isPlayerOnline(p_))
        {
            ...
            if (!pli.global_lost.containsKey(p_))
            {
                ...
                if (this.economyrewards && MinigamesAPI.getAPI().economyAvailable())
                {
                    ...
                    MinigamesAPI.getAPI();
                    MinigamesAPI.econ.depositPlayer(p.getName(), this.econ_reward);
                    received_rewards_msg = received_rewards_msg.replaceAll("<economyreward>", plugin.getConfig().getString("config.rewards.economy_reward"));
                ...
                if (true)
                {
                    ...
                    Util.sendMessage(this.plugin, p, pli.getMessagesConfig().you_got_a_participation_reward.replaceAll("<economyreward>",
                            Integer.toString(this.participation_econ_reward)));
                }
            ...
            {
                String received_rewards_msg = pli.getMessagesConfig().you_received_rewards;
                received_rewards_msg = received_rewards_msg.replaceAll("<economyreward>", plugin.getConfig().getString("config.rewards.economy_reward_for_participation"));
                Util.sendMessage(this.plugin, p, received_rewards_msg);
                MinigamesAPI.econ.depositPlayer(p, plugin.getConfig().getInt("config.rewards.economy_reward_for_participation"));
